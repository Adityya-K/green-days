...
<div class="center pt-20">
	...
	{:else if (weatherData.current.weathercode = 1)}
		<img src="https://www.iconarchive.com/download/i107712/google/noto-emoji-travel-places/42664-sun-behind-small-cloud.1024.png" alt="icon"/>
		<h2>Mainly Clear</h2>
	...
	{:else if (weatherData.current.weathercode = 45)}
		<img src="https://cdn.icon-icons.com/icons2/1370/PNG/512/if-weather-49-2682802_90798.png" alt="icon"/>
		<h2>Fog</h2>
	{:else if (weatherData.current.weathercode = 48)}
		<img src="https://cdn.icon-icons.com/icons2/1370/PNG/512/if-weather-49-2682802_90798.png" alt="icon"/>
		<h2>Depositing Rime Fog</h2>
	{:else if (weatherData.current.weathercode = 51)}
		<img src="https://cdn2.iconfinder.com/data/icons/weather-365/64/weather-sun-cloud-rain-512.png" alt="icon"/>
		<h2>Light Drizzle</h2>
	...
	{:else if (weatherData.current.weathercode = 71)}
		<img src="https://cdn1.iconfinder.com/data/icons/weather-forecast-meteorology-color-1/128/weather-sunny-snow-512.png" alt="icon"/>
	...
	{:else if (weatherData.current.weathercode = 95)}
		<img src="https://cdn4.iconfinder.com/data/icons/weather-717/64/thunderstorm-sun-storm-rain-weather-cloud-512.png" alt="icon"/>
		<h2>Thunderstorm</h2>
